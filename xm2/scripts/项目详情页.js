...
//图片放大
  ...
  $("#right_footer div:not(#f)").click(function(e) {
   // $(".jqzoom img").prop("src","images/pro_img/blue_"+this.id+"_small.jpg");
	...
	$(this).css("border","#06F 1px solid").siblings("#right_footer div:not(#f)").css("border","0px");
	$("#floorimg").attr("src",' '+'images/pro_img/'+num+'_'+this.id+'_big.jpg'); 
	$("#thickImg").attr("href",' '+'images/pro_img/'+num+'_'+this.id+'_big.jpg');
});
//尺寸
 $("#size div").eq(0).css("background","#06C");  
  ...
  $("option").click(function(e) {
    ...
    $("#star").mousemove(function(e){
		...
		//alert(s)
	if(s>=0&&s<8){
			$(this).css("background-position","0px"+" -"+0+"px").click(function(e) {
             $(this).css("background-position","0px"+" -"+0+"px")   
            });;
			return k=0;
			}else if(s>=8&&s<16){
			$(this).css("background-position","0px"+" -"+96+"px").click(function(e) {
             $(this).css("background-position","0px"+" -"+16+"px")   
            });;
			return k=1;
			}else if(s>=16&&s<32){
			$(this).css("background-position","0px"+" -"+112+"px").click(function(e) {
             $(this).css("background-position","0px"+" -"+32+"px")   
            });;
			return k=2;	
				}else if(s>=32&&s<48){
			$(this).css("background-position","0px"+" -"+128+"px").click(function(e) {
             $(this).css("background-position","0px"+" -"+48+"px")   
            });;
			return k=3;
			}else if(s>=48&&s<60){
			$(this).css("background-position","0px"+" -"+144+"px").click(function(e) {
             $(this).css("background-position","0px"+" -"+64+"px")   
            });;	
			return k=4;
				}else if(s>=60&&s<72){
			$(this).css("background-position","0px"+" -"+160+"px").click(function(e) {
